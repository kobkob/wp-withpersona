...
( function( $ ) {
    ...
    if ($('#wp_with_persona_settings').length){
        ...
        //$.getJSON('https://dev.lennon.com/wp-json/wp/v2/posts/?', function(data) {
        //    const pages = data.map ( function(i) { return i.title } );
        //    console.log(data);
        //    console.log(pages);
        //});
        doAutocomplete();
        $("#wpp-settings-page-add").click(function(e){
            ...
            $(field).find('input').attr("name", "wpwithpersona_add_page_btn"+"["+id+"]");
        ...
        function doAutocomplete(){ $(".wpp-multitext-item input").autocomplete({
