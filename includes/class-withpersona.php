...
class WpWithPersona {
	...
	public function wp_withpersona_new_user_register( $user_id ) {
        ...
        public function shortcodes_init() {
                ...
                add_shortcode( $sc, array( $this, 'wp_withpersona_shortcode' ) );
        }
	 ...
	 * @since    1.0.1
	 */
	function wp_withpersona_dashboard_page() {
	    $file_name = plugin_dir_path( dirname( __FILE__ ) ) . 'admin/dashboard.php';
		...
		$homepage = file_get_contents('http://54.210.194.36:3000/table');
                ob_start();
                include plugin_dir_path( dirname( __FILE__ ) ) . 'templates/wp_withpersona-display.php';
                $o = ob_get_clean();
                return $o;
        }
