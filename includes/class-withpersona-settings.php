...
class WpWithPersona_Settings
{
    ...
    {
        $page = add_options_page(__('WP With Persona Settings', 'wp-withpersona'), __('WP With Persona Settings', 'wp-withpersona'), 'manage_options', $this->parent->_token . '_settings', [$this, 'settings_page']);
    ...
    public function settings_assets()
    {
        ...
        wp_register_script($this->parent->_token . '-settings-js', $this->parent->assets_url . 'js/settings' . $this->parent->script_suffix . '.js', ['farbtastic', 'jquery'], '1.0.0');
        ...
        if (is_array($this->settings)) {
            ...
            foreach ($this->settings as $section => $data) {
                ...
                foreach ($data[ 'fields' ] as $field) {
                    ...
                    // Add field to page
                    add_settings_field($field[ 'id' ], $field[ 'label' ], [$this->parent->admin, 'display_field'], $this->parent->_token . '_settings', $section, ['field' => $field, 'prefix' => $this->base]);
                }
